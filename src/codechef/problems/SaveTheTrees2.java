...
public class SaveTheTrees2 {
    ...
    public static ArrayList<Point> grahamScan(Point[] points, Point ref) {
    ...
    public static long setUpTest(int N, int[] A) {
        ...
        ArrayList<Point> convexList = grahamScan(points, ref);
        //now compute the area
        long area = 0;


        Point p0 = convexList.get(0);
        Point p1 = convexList.get(convexList.size() - 1);
